...
export class Character {
  ...
  get verticalOrientation(): VerticalOrientation {
    switch (this.computedStyle.textOrientation) {
      ...
      case 'mixed':
      default:
        return tuOrURe.test(this.content) ? 'U' : 'R'
    }
  }

  get isPunctuation(): boolean {
    return punctuationRe.test(this.content)
  }

  get isEOL(): boolean {
    return eolRe.test(this.content)
  }
